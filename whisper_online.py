...
class ASRBase:
    ...
    def __init__(self, lan, modelsize=None, cache_dir=None, model_dir=None, logfile=sys.stderr, device="cpu", compute_type="float16"):
...
class FasterWhisperASR(ASRBase):
    ...
    def load_model(self, modelsize=None, cache_dir=None, model_dir=None):
        ...
        model = WhisperModel(modelsize, device=self.device, compute_type=self.compute_type) #, download_root="faster-disk-cache-dir/")
        return model
